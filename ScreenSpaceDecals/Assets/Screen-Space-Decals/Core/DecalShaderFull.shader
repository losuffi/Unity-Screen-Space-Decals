	...
	SubShader
	{
		Pass
		{
			...
			v2f vert (half4 v : POSITION)
			{
				...
				o.ray = mul (UNITY_MATRIX_MV, v).xyz * half3(1,1,-1);
			...
			)
			{
				...
				half3 vpos = i.ray * depth;
				half4 wpos = mul (_CameraToWorld, half4(vpos,1));
				half3 opos = mul (_World2Object, wpos);
